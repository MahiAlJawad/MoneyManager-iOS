...
enum MainCategory: Category, Hashable, Identifiable {
...
enum Subcategory: Category, Hashable, Identifiable {
    var id: Self { return self }
...
let allCategories: [MainCategory] = [
    .Groceries, .Communication, .Housing, .Life_Entertainment, .Shopping , .Transportation ,.Restaurant
]
