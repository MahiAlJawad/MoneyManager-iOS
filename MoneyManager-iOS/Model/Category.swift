...
extension Category {
    static let sampleCategory1: Category = .init(name: "Investments", icon: "dollarsign.bank.building", color: .red, parentCategory: "", subCategories: [])
    static let sampleCategory2: Category = .init(name: "Restaurant", icon: "fork.knife", color: .orange, parentCategory: "", subCategories: [])
    static let sampleCategory3: Category = .init(name: "Housing", icon: "house", color: .red, parentCategory: "", subCategories: [])
    static let sampleCategory4: Category = .init(name: "Tranportation", icon: "car", color: .red, parentCategory: "", subCategories: [])
    static let sampleCategory5: Category = .init(name: "Vehicle", icon: "bus", color: .red, parentCategory: "", subCategories: [])
    static let sampleCategory6: Category = .init(name: "Shopping", icon: "bag", color: .red, parentCategory: "", subCategories: [])
    static let sampleCategory7: Category = .init(name: "Gaming", icon: "gamecontroller", color: .red, parentCategory: "", subCategories: [])
